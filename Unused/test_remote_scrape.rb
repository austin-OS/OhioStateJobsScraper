# Test code for filtering only remote jobs using the correct facet.
...
# This code will display all facet info.
#puts 'Filter Options'
...
puts 'Enter the index of a job to retrieve additional info for:'
text_input = gets
